...
;;(first (str/split (str/replace (str/upper-case "a b c d") "A" "X") #" "))
(-> "a b c d"
    str/upper-case
    (str/replace "A" "X")
    (str/split #" ")
...
((comp first reverse sort) '(1 8 3 4))
